...
# 隐私页跳过（个人详情页不截图）—— 先关闭以保证遍历覆盖
SKIP_PERSONAL_PAGES = False
...
PRIVACY_ID_KEYWORDS = ["space", "mine", "profile", "user_card", "personal", "user_space"]
PRIVACY_TEXT_KEYWORDS = ["个人主页", "我的主页", "编辑资料", "粉丝数", "获赞", "B币"]
